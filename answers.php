...
Lorem ipsum dolor, sit amet consectetur adipisicing elit. Natus ipsam eaque, molestias sed omnis iste molestiae odio nisi libero fugiat minima, fuga numquam amet, hic placeat doloribus nemo eveniet itaque.          
      ...
      <div class="row">
        <div class="col-lg-1"></div>
          ...
          <div class="col-sm-2 col-lg-2 col-md-2 py-3">
            <i class="far fa-comments text-success"></i> <span  id="commentCount">29</span>
 
          </div>
          <div class="col-sm-2 col-lg-2 col-md-2 py-3">
            <i class="fas fa-comment-dots text-success"></i> <span id="comment"><a href="comment.php?id=${cursor.value.id}">Comment</a></span>
...
<div class="row">
  ...
  <div class="col-11 display-6 text-primary mt-4">
    Answers
    <hr class="text-black" >
