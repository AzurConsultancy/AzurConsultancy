...
?>
     ...
     <hr class="text-black" >
      ...
      <div class="container  container_one px-5  py-5 my-5 mb-5 " data-aos="flip-up">
        <div class="row">
          <div class="col-md-12">
   ...
   <!-- guidance -->
       <div class="col-md-3">
         ...
         <hr class="bg-light mt-0 ml-0" style="width: 7rem; height: 0.1rem;">
           <ul class="list-unstyled ml-5">
               <li class="my-2"><a class="text-info" href="collegeListPersonal.php">Build Your  List</a> </li>
           </ul>
       </div>
  ...
  <script src="Assets/JS/collegesByArt.js"></script>
