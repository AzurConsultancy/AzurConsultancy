...
?>
        ...
        <div class="contact">
            <div class="container-contact">
                ...
                <form class="contact-form validate-form" name="myform">
                    <span class="contact-form-title">
                        Get in touch and collaborate with us
                    </span>
    
                    <div class="wrap-input1 validate-input" data-validate = "Name is required">
                        <input class="input1" id="cname" type="text" name="cname" placeholder="Name" required>
                        <span class="shadow-input1"></span>
                    </div>
    
                    <div class="wrap-input1 validate-input" data-validate = "Valid email is required: ex@abc.xyz" >
                        <input class="input1" id="email" type="text" name="email" placeholder="Email" required>
                        <span class="shadow-input1"></span>
                    </div>
